...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    const parseColorToVec3 = (hex: string) => {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uTopColor: { value: parseColorToVec3(topColor) },
        uBottomColor: { value: parseColorToVec3(bottomColor) },
  ...
  }, [webGLSupported, quality, interactive, pillarRotation, topColor, bottomColor, intensity, glowAmount, pillarWidth, pillarHeight, noiseIntensity]);
