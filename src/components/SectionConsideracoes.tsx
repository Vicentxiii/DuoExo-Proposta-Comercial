...
export default memo(function SectionConsideracoes() {
  const contrastItems = [
    { text: "Seus concorrentes mostram fotos estáticas. Sua marca oferece uma experiência interativa inesquecível.", highlight: "experiência interativa inesquecível" },
    { text: "Enquanto outros dependem do vendedor para explicar, seu cliente visualiza e se apaixona sozinho.", highlight: "visualiza e se apaixona sozinho" },
    { text: "Empresas que disputam preço encolhem. Marcas que investem em experiência dominam o mercado.", highlight: "dominam o mercado" }
  ];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-8 space-y-16">
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-brand-dark/60 border border-white/5 relative overflow-hidden space-y-4">
          ...
          <p className="text-lg sm:text-2xl font-light text-white leading-relaxed relative z-10">
            Este não é um gasto com software. É a construção de um <strong className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-brand-gold font-semibold">ativo digital exclusivo</strong> que valoriza sua marca e gera vendas todos os dias.
          </p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-brand-dark border border-white/5 flex flex-col md:flex-row gap-8 items-start md:items-center">
          ...
          <p className="text-zinc-300 text-sm sm:text-base leading-relaxed font-light">
            Esta ferramenta reduz dúvidas, aumenta o tempo de visita, fortalece sua marca e cria um diferencial que seus concorrentes não conseguem copiar. Resultado: mais vendas, com menos esforço.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 border-t border-white/5 pt-12">
          <div className="p-6 rounded-2xl bg-brand-dark/30 border border-white/5 flex flex-col justify-between min-h-[140px]">
            <span className="font-mono text-[9px] text-zinc-500 uppercase tracking-widest">Investimento Único</span>
            <p className="text-lg font-semibold text-white tracking-tight leading-snug">
              O investimento é feito uma vez. O retorno é para sempre.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-brand-accent/5 border border-brand-accent/20 flex flex-col justify-between min-h-[140px] border-glow-accent">
            ...
            <p className="text-lg font-semibold text-white tracking-tight leading-snug">
              O custo de não ter esta ferramenta se repete todo mês.
            </p>
          </div>
        </div>
        ...
        <div className="p-10 md:p-16 rounded-3xl bg-brand-dark border border-white/10 relative overflow-hidden text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-2xl md:text-4xl font-extrabold text-white tracking-tight">
              Sua marca merece essa experiência
            </h3>
          </div>
          
          <p className="text-base sm:text-lg md:text-xl font-light text-zinc-300 leading-relaxed max-w-3xl mx-auto">
            Esta não é uma escolha entre ter ou não um configurador. É a escolha entre oferecer uma experiência que vende ou continuar fazendo o que todo mundo faz. Vagas para novos projetos são limitadas. Garanta a exclusividade da sua marca.
          </p>
          ...
          <div className="pt-4 flex flex-col items-center gap-6">
            ...
            >
              ...
              <span className="relative z-10 text-sm md:text-base">QUERO COMEÇAR MEU PROJETO</span>
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </motion.a>
            
            <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest">
              Atendimento personalizado via WhatsApp · Resposta imediata
            </p>
          </div>
        </div>
